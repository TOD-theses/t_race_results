...
python3 compare_tods.py ../rq1-3_search.csv has_indirect_dependencies.csv filtered_by_same_value_collision.csv filtered_by_indirect_dependencies_quick.csv > comparison_indirect_dependencies.csv